...
public class MyRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Obra obra2 = new Obra();
        obra1.setObrNombre("Luciernaga 345");
        obra1.setObrTipo("Pintura");
        obra1.setObrCosto(100L);
        obra1.setExpId(1006L);
        
        obraRepositorio.save(obra1);
        
        logger.info("Obra guardada: {}", obra1);
        logger.info("Obra guardada id: {}", obra1.getObrId());
        ...
        var obras = obraRepositorio.findAll();
        logger.info("{}", obras);
        
        logger.info("------------------------");

        logger.info("Todas las obras ordenadas por nombre y en orden descendente");
        var obrasOrdenadas = obraRepositorio.findAll(Sort.by(Sort.Direction.DESC, "obrNombre"));
